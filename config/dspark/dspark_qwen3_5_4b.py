...
exp_name = "dspark_block8_qwen3_5_4b"
seed = 42

model = dict(
    target_model_name_or_path="/storage/caden/models/Qwen3_5-4B",
    block_size=7,
    num_draft_layers=5,
    # Qwen3.5-4B has 32 layers; pick 5 evenly-spaced non-final layers.
    target_layer_ids=[1, 8, 16, 23, 30],
    # <|fim_pad|> token (ID 248063) serves as the mask token for Qwen3.5.
